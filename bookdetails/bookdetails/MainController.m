...
{
    [super viewDidLoad];
//    myArray=[NSMutableArray arrayWithObjects:@"Book Name",@"Author Name", nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.booknameLabel.text=[NSString stringWithFormat:@"%@",bookdet.bookname];
    cell.authornameLabel.text=[NSString stringWithFormat:@"%@",bookdet.authorname];
