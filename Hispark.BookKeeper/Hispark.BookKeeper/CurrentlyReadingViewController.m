...
#import "CurrentlyReadingViewController.h"

@interface CurrentlyReadingViewController ()
{
...
@implementation CurrentlyReadingViewController
...
- (void)viewDidLoad
{
    ...
    completedBookDatas = [coredatamanagerobj GetAllCurrentlyReading];
